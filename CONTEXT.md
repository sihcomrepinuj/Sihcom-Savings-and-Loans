...
- **admin/settings.html** - Global interest rate/period config, affiliate USD-to-ISK ratio config
...
7. **settings** - key (PK), value — keys include: interest_rate, interest_period, usd_to_isk_ratio
